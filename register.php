...
<body>
    ...
    <main>
    <!-- enctype="multipart/form-data" ←が記述ないとファイルをアップロードは動作しない-->
        <form action="register_confirm.php" method="post" enctype="multipart/form-data">
            <div class="form_contents">
                ...
                <div class="password">
                    ...
                    <!-- id="confirm" oninput="ConfirmPassword(this)" required　←パスワード確認部分 -->
    ...
    <footer>
        ⓒ2019 Internous.inc. All rights reserved
    </footer>
    <script>
        // パスワード確認チェック部分
        function ConfirmPassword(confirm) {
            var input1 = password.value; //最初のパスワード
            var input2 = confirm.value;　//パスワード確認
            if (input1 != input2) {
